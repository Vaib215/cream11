...
export default function BasketballWaitlistPage() {
      ...
      <div className="relative z-10 container mx-auto px-4 py-12">
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-white via-orange-200 to-red-200 bg-clip-text text-transparent leading-tight">
                Basketball Fantasy <span className="text-orange-400">AI</span>
              </h1>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="flex flex-col items-center gap-2 border p-2">
                  <Image src={"/ai.webp"} width={80} height={80} alt={"AI"} />
                ...
                <div className="flex flex-col items-center gap-2 border p-2">
                  ...
                  />
                  <div className="text-center">
                    <p className="text-xs text-foreground uppercase text-balance">
                      Advanced Analytics
                    </p>
                  </div>
                </div>
              ...
              {!isSubmitted ? (
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <p className="text-xs text-muted-foreground">
                    We&apos;ll notify you as soon as basketball predictions are
                    available. No spam, promise! 🤝
                  </p>
                </form>
              ) : (
                <div className="text-center space-y-3">
                  ...
                  <p className="text-muted-foreground">
                    Thanks for joining! We&apos;ll email you as soon as
                    basketball predictions are ready.
                  </p>
                  <Button
                    variant="outline"
          ...
          <div className="flex items-center justify-center max-md:hidden">
            <div className="relative">
              {/* Glow effect */}
              <div className="absolute inset-0 bg-gradient-to-r from-orange-500/20 to-red-500/20 rounded-full blur-3xl scale-150" />

              {/* 3D Basketball Animation */}
        ...
        <div className="text-center pt-8 border-t border-border/50">
          <p className="text-sm text-muted-foreground">
            Powered by{" "}
            <span className="text-orange-400 font-semibold">Cream11</span> •
