...
export function TeamAnalysis({
  ...
  return (
    <TooltipProvider>
      <div className="bg-white dark:bg-gray-800/50 rounded-xl p-4 sm:p-5 shadow-sm border border-gray-100 dark:border-gray-700 min-h-[150px]">
          ...
          <Tooltip delayDuration={150}>
            ...
            <TooltipContent side="top" align="end">
              <p className="text-xs max-w-[250px]">
                This AI-generated analysis considers player statistics (recent &
                historical), team balance, C/VC choices, and potential toss
                impact based on the venue.
              </p>
            </TooltipContent>
          </Tooltip>
        </div>
